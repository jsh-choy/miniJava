...
public class ELFMaker {
	...
	public ELFMaker(ErrorReporter errors, long textSize, long bssSize) {
		...
		bss.data = null;
		bss.sh_size = bssSize;
		bss.sh_type = SHT_NOBITS; // SHT_NOBITS
		bss.sh_flags = SHF_WRITE | SHF_ALLOC; // write and alloc
		sections.add( bss );
	...
	private class ELF {
		public int ei_magic = 0x464C457F;
